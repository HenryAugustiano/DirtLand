<!DOCTYPE html><!-- http://localhost/shop/loaddata.jsp load this first ! -->
<html>
<head>
        <!-- Required meta tags -->
    <meta charset="utf-8">
...
<%
 if(session.getAttribute("authenticatedUser") != null){
        %>
        <h3> <span class="badge badge-pill badge-light">  Signed in as: <%=session.getAttribute("authenticatedUser")%>  </span></h3>
        <%
 }
%>
